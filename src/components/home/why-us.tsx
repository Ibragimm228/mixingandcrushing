				...
				<div className='grid grid-cols-1 lg:grid-cols-2 gap-16 items-center'>
					...
					>
						...
						>
							...
							<div className='relative flex items-start space-x-6 group hover:bg-slate-800/50 p-6 rounded-2xl transition-all duration-300 border border-slate-700/50 group-hover:border-amber-500/30'>
								<motion.div
									variants={hoverRotate}
									className='flex-shrink-0 w-16 h-16 bg-gradient-to-br from-amber-500/20 to-orange-500/20 rounded-2xl flex items-center justify-center group-hover:from-amber-500 group-hover:to-orange-600 transition-all duration-300 shadow-xl'
								>
									<svg
										className='w-8 h-8 text-amber-500 group-hover:text-white transition-colors duration-300'
										fill='currentColor'
										viewBox='0 0 24 24'
									>
					...
					<div className='relative'>
						...
						<motion.div
							...
							className='absolute bottom-0 right-0 translate-x-1/4 translate-y-1/4 bg-gradient-to-br from-amber-500 to-orange-600 text-white p-8 rounded-2xl shadow-2xl'
						>
							<motion.div
								animate={{ rotate: [0, 360] }}
								transition={{ duration: 8, repeat: Infinity, ease: 'linear' }}
								className='absolute top-4 right-4 w-6 h-6 border-2 border-white/30 border-t-white rounded-full'
							/>
						...
						<motion.div
							...
							className='absolute top-0 left-0 -translate-x-1/4 -translate-y-1/4 bg-gradient-to-br from-slate-800 to-slate-900 border border-amber-500/30 text-white p-6 rounded-2xl shadow-2xl backdrop-blur-sm'
						>
